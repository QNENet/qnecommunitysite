...
var DefaultAligner = /*#__PURE__*/ (function () {
  function DefaultAligner(quill, options) {
    ...
    this.alignments =
      ((_this$alignments = {}),
      _defineProperty(_this$alignments, LEFT_ALIGN, {
        name: LEFT_ALIGN,
      ...
      _defineProperty(_this$alignments, CENTER_ALIGN, {
        ...
        apply: function apply(el) {
          ...
          if (!ctx) return;
          if (!ctx.precedesNewline)
            _this.quill.insertText(ctx.index + 1, "\n", "user");
      ...
      value: function getContext(el) {
        ...
        return {
          ...
          precedesNewline:
            next &&
            next.ops &&
            typeof ((_next$ops$ = next.ops[0]) === null || _next$ops$ === void 0
              ? void 0
              : _next$ops$.insert) === "string" &&
          ...
          case RIGHT_ALIGN:
            return (
              (attributes === null || attributes === void 0
                ? void 0
                : attributes["float"]) === alignment.name
            );

          case CENTER_ALIGN:
            return (
              (afterAttributes === null || afterAttributes === void 0
                ? void 0
                : afterAttributes.align) === "center"
            );
    ...
    },
    {
      ...
      value: function addToolbarStyle(formatter, toolbar) {
        if (formatter.options.align.toolbar.mainStyle) {
          Object.assign(
            toolbar.style,
            formatter.options.align.toolbar.mainStyle
          );
        }
      },
    },
    {
      ...
      value: function addButtonStyle(button, index, formatter) {
        if (formatter.options.align.toolbar.buttonStyle) {
          Object.assign(
            button.style,
            formatter.options.align.toolbar.buttonStyle
          );
...
var AlignAction = /*#__PURE__*/ (function (_Action) {
  ...
  function AlignAction(formatter) {
    ...
    _this.aligner = new DefaultAligner(
      formatter.quill,
      formatter.options.align
    );
...
var ResizeAction = /*#__PURE__*/ (function (_Action) {
  ...
  function ResizeAction(formatter) {
    ...
    _defineProperty(_assertThisInitialized(_this), "onDrag", function (event) {
      ...
      if (
        _this.dragHandle === _this.topLeftHandle ||
        _this.dragHandle === _this.bottomLeftHandle
      ) {
      ...
      value: function repositionHandles(handleStyle) {
        ...
        if (handleStyle) {
          ...
          if (handleStyle.height) {
            handleYOffset = "".concat(
              -parseFloat(handleStyle.height) / 2,
              "px"
            );
          }
        }
...
class ButtonAction extends Action {
  ...
  onCreate() {
    ...
    this.button.innerHTML = '<i class="material-icons">create</i> Edit Image';
    ...
    this.button.classList.add("center-align");
    this.button.classList.add("center");
    this.formatter.overlay.appendChild(this.button);

    this.button.addEventListener("click", () => {
      var node = this.formatter.currentSpec.getTargetElement();

      if (node) {
        var blot = this.formatter.quill.constructor.find(node);
        console.log(blot.domNode.src);
        ...
        image.src = blot.domNode.src;
        cropImage.src = blot.domNode.src;

        image.onload = function () {
          // Set the canvas the same width and height of the image
          let newiamge = document.getElementById("sourceImage");
          console.log(newiamge.width, newiamge.height, "newiamge");
          canvas.width = newiamge.width;
          canvas.height = newiamge.height;
        ...
        //Saving optionq
        document.querySelector(".image-save").addEventListener("click", () => {
          let dataurl = canvas.toDataURL("image/png");
          blot.domNode.src = dataurl;
  ...
  _createClass(BlotSpec, [
    ...
    },
    {
      ...
      value: function getActions() {
        return [AlignAction, ResizeAction, DeleteAction, ButtonAction];
      },
    },
    {
    ...
    _defineProperty(_assertThisInitialized(_this), "onTextChange", function () {
      Array.from(
        document.querySelectorAll(
          ""
            .concat(_this.selector, ":not([")
            .concat(MOUSE_ENTER_ATTRIBUTE, "])")
        )
      ).forEach(function (unclickable) {
  ...
  _createClass(UnclickableBlotSpec, [
    {
      ...
      value: function init() {
        ...
        this.hideProxyImage();
        (_this$proxyImage = this.proxyImage) === null ||
        _this$proxyImage === void 0
          ? void 0
          : _this$proxyImage.addEventListener("click", this.onProxyImageClick);
      ...
      value: function createActions(spec) {
        ...
        var actions = spec.getActions().filter(function (ActionClass) {
          return (
            ...
            ActionClass.formats.some(function (f) {
              return (
      ...
      value: function repositionOverlay() {
        ...
        this.withParentNode(function (pn) {
          ...
          Object.assign(_this5.overlay.style, {
            display: "block",
            left: "".concat(
              specRect.left - parentRect.left - 1 + pn.scrollLeft,
              "px"
            ),
